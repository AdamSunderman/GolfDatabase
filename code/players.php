...
<body>
	...
	<form method="get" action="playertable.php" target="table">
		<p><a href="playertable.php" target="table"><font color="0000FF">Update Table/Remove Filters</font></a></p>
	</form>
	<!-- Form 1 - Filter players -->
	<section id="topforms">
	<div id="form1">
	<form method="get" action="playertable.php" target="table" class="sidebysideform">
		<fieldset>
			<legend style="font-size: 16pt;"><b>Filter Players By One Or More Conditions</b></legend>
			<p>
				By First Name: <input type="text" name="fname" /> (leave blank for all)
			</p>
			<p>
				By Last Name: <input type="text" name="lname" /> (leave blank for all)</p>
			<p>
	...
	<!-- Form 2 - Add Player -->
	<div id="form2">
	<form method="post" action="addplayer.php" target="table" class="sidebysideform">
		<fieldset>
			<legend style="font-size: 16pt;"><b>Add A New Player</b></legend>
			<p>
