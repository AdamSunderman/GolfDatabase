...
<body>
		...
		<?php
			...
			if(!$stmt->bind_result($name, $loc, $rating, $slope, $yards, $par, $h1, $h2, $h3, $h4, $h5, $h6, $h7, $h8, $h9, $h10, $h11, $h12, $h13, $h14, $h15, $h16, $h17, $h18)){
				echo "Bind failed: "  . $stmt->errno . " " . $stmt->error;			
			}
			while($stmt->fetch()){
 				echo "<tr><td>" . $name . "</td><td>" . $loc . "</td><td>" . $rating . "</td><td>" . $slope . "</td><td>" . $yards . "</td><td>" . $par . "</td><td>" . $h1 . "</td><td>" . $h2 . "</td><td>" . $h3 . "</td><td>" . $h4 . "</td><td>" . $h5 . "</td><td>" . $h6 . "</td><td>" . $h7 . "</td><td>" . $h8 . "</td><td>" . $h9 . "</td><td>" . $h10 . "</td><td>" . $h11 . "</td><td>" . $h12 . "</td><td>" . $h13 . "</td><td>" . $h14 . "</td><td>" . $h15 . "</td><td>" . $h16 . "</td><td>" . $h17 . "</td><td>" . $h18 . "</td></tr>";
			}
			$stmt->close();
		?>
